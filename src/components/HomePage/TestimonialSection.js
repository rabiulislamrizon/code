    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="section-header">
          ...
          <p className="wow fadeInLeft" data-wow-delay=".4s">Rabiul Islam Rizon is a highly skilled and dedicated professional with expertise in WordPress, ReactJS, and SEO. His clients praise his ability to deliver exceptional results, solve complex challenges, and ensure timely project completion. Rabiul's attention to detail, creativity, and excellent communication make him a trusted partner for digital solutions.</p>
        </div>
      </div>
